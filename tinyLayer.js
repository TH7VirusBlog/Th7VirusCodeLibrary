  ...
  return {
    ...
    open: function(argsObj){
      ...
      if(Number(argsObj.type) === 0){
        argsObj.title = argsObj.title || 'Title';
        argsObj.icon = Tools.currentPath + Tools.assetsName + argsObj.icon + '_icon.png' || Tools.currentPath + Tools.assetsName + 'succ_icon.png';
        argsObj.closeBtn = argsObj.closeBtn || 1;
        argsObj.btn = argsObj.btn || ['Okey'];
