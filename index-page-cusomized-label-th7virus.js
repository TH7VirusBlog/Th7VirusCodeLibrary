// ---------------------------------------------------
// مدونة فيرس للمعلوميات أكبر مدونة تقنية في مصر
// TH7VIRUS.COM is the biggest tech blog in egypt
// ---------------------------------------------------
...
document.write('<div class="thumbnail">'+'<a href="'+posturl+'"><img id="postimg" src="'+thumburl+'" title="'+posttitle+'" alt="'+posttitle+'" /></a>'+'</div>');
...
document.write( unescape( '<center><a href="http://www.th7virus.com/" target="_blank"><span style="font-size: x-small;">Get this Blogger widgets</span></a></center>' ) );
}
